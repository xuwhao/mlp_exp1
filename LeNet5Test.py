...
lrs, epoch, batches = [1e-3], 20, [100,256,600]
    ...
    for lr in lrs:
        for batch in batches:
            for init in [True, False]:
                ...
                conv_kn, conv_step = kernel[0], kernel[1]
                pool_kn, pool_step = kernel[2], kernel[3]
                # 保存的文件名 卷积核_卷积步长_池化核_池化步长_学习率_batch_初始化
                file_name = str(conv_kn) + '_' + str(conv_step) + '_'
                file_name += str(pool_kn) + '_' + str(pool_step) + '_'
